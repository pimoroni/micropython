// JavaScript half of the simulator's fetch-backed HTTP primitive (see
// simulator/jsfetch.c). Lives in a --js-library so it can use full JS (fetch,
// promises, object literals) without the EM_ASM comma/macro pitfalls.
//
...
// WASM stack (JSPI) until the promise settles, giving Python a blocking call.
