...
# unwind/rewind silently. tools/test-asyncify-fast.mjs guards this by forcing a
# suspend through every dispatch path (operators, subscript, call, property,
# iter/next, context managers, recursion, generators, except handlers).
